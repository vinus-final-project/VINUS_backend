...
CATEGORY_KEYWORDS = {
    ...
    "차 메뉴": "차", "차 종류": "차", "차 보여": "차", "티 메뉴": "차", "티 종류": "차", "티 보여": "차",
    "요거트": "요거트",
...
PAGE_PREV_KEYWORDS = ("이전 페이지", "이전페이지", "이전 장", "이전장",
                      ...
                      "이전")
#   ⚠ 단독 "다음"/"이전"은 복합 키워드 뒤에 배치 (먼저 매칭돼도 결과 동일하나 가독성)
#     "다음에 올게요" 류가 페이지 넘김으로 처리될 수 있으나 키오스크 문맥상 감수
...
REQUIRED_OPTION_KEYWORDS = {
    # 온도
    "아이스": "ICE", "차갑": "ICE", "시원": "ICE", "차가": "ICE","얼음": "ICE", "찹게": "ICE",
    ...
    "무설탕": "0%", "안 달게": "0%", "설탕 빼": "0%", "0퍼센트": "0%", "설탕없이": "0%",
